                ...
                <div class="col-md-10">
                    <div style="padding: 87px 58px;margin: 100px 0;" class="card">
                        <div class="card-body text-center">
                            ...
                            <p>Go back to <a style="color: #1b4b72" href="{{action('User\IndexController@index')}}">Home Page</a></p><br />
                            <h3><a style="color: #006400" href="{{action('User\IndexController@index')}}">Make Payment</a></h3>
                        </div>
                    </div>
                </div>
                <div class="col-md-1"></div>
