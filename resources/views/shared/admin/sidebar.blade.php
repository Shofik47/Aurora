        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav flex-column">
                    ...
                    <li class="nav-item mb-2">
                        <a class="nav-link {{ (Request::is('admin/package/*','admin/package') ? 'active' : '') }}" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-4" aria-controls="submenu-4"><i class="far fa-chart-bar"></i>Packages</a>
                        <div id="submenu-4" class="collapse submenu {{ (Request::is('admin/package/*','admin/package') ? 'show' : '') }}" style="">
                            <ul class="nav flex-column">
                                <li class="nav-item mb-2">
